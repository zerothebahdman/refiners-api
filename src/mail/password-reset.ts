const PASSWORD_RESET_EMAIL = (url: string) => `<!DOCTYPE html>
...
<body style="background-color: #ececec; margin: 0; padding: 0; -webkit-text-size-adjust: none; text-size-adjust: none;">
	<table border="0" cellpadding="0" cellspacing="0" class="nl-container" role="presentation"
		style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; background-color: #ececec;" width="100%">
		<tbody>
			<tr>
				<td>
							...
							<tr>
								<td>
									<table align="center" border="0" cellpadding="0" cellspacing="0"
										...
										style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; background-color: #ffffff; color: #000000; width: 605px;"
										width="605">
										<tbody>
											<tr>
												...
												<td class="column column-1"
													...
													<table border="0" cellpadding="0" cellspacing="0"
														...
														<tr>
															<td style="width:100%;text-align:center;">
																<h1
																	style="margin: 0; color: #555555; font-size: 23px; font-family: 'Work Sans', 'Trebuchet MS', 'Lucida Grande', 'Lucida Sans Unicode', 'Lucida Sans', Tahoma, sans-serif; line-height: 120%; text-align: center; direction: ltr; font-weight: 700; letter-spacing: normal; margin-top: 0; margin-bottom: 0;">
													...
													<table border="0" cellpadding="0" cellspacing="0"
														...
														<tr>
															<td
																...
																<div
																	style="color:#000000;font-size:14px;font-family:'Work Sans', 'Trebuchet MS', 'Lucida Grande', 'Lucida Sans Unicode', 'Lucida Sans', Tahoma, sans-serif;font-weight:400;line-height:120%;text-align:left;direction:ltr;letter-spacing:0px;mso-line-height-alt:16.8px;">
																	...
																	<p style="margin: 0;">You can reset your password by
													...
													<table border="0" cellpadding="10" cellspacing="0"
														...
														<tr>
															<td>
																<div align="center">
																	<!--[if mso]><v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="google.com" style="height:52px;width:321px;v-text-anchor:middle;" arcsize="16%" stroke="false" fillcolor="#7e3294"><w:anchorlock/><v:textbox inset="0px,0px,0px,0px"><center style="color:#ffffff; font-family:'Trebuchet MS', Tahoma, sans-serif; font-size:16px"><![endif]--><a
																		href="${url}"
																		style="text-decoration:none;display:block;color:#ffffff;background-color:#7e3294;border-radius:8px;width:55%; width:calc(55% - 2px);border-top:1px solid #7e3294;font-weight:400;border-right:1px solid #7e3294;border-bottom:1px solid #7e3294;border-left:1px solid #7e3294;padding-top:10px;padding-bottom:10px;font-family:'Work Sans', 'Trebuchet MS', 'Lucida Grande', 'Lucida Sans Unicode', 'Lucida Sans', Tahoma, sans-serif;text-align:center;mso-border-alt:none;word-break:keep-all;"
																		target="_blank"><span
